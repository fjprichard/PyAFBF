...
setup(
    ...
    description='Generate image textures from anisotropic fractional Brownian fields',
    # Long description
    ...
    install_requires=['numpy>=1.26.4', 'matplotlib>=3.10.0', 'scipy>=1.16.1',
                      'imageio>=2.37.0', 'pickle'],
